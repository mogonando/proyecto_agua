...
#define UART_INITPINS_echo1_FGPIO FGPIOA             /*!<@brief FGPIO peripheral base pointer */
#define UART_INITPINS_echo1_GPIO GPIOA               /*!<@brief GPIO peripheral base pointer */
#define UART_INITPINS_echo1_GPIO_PIN_MASK (1U << 8U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define UART_INITPINS_echo1_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define UART_INITPINS_echo1_PIN 8U                   /*!<@brief PORT pin number */
#define UART_INITPINS_echo1_PIN_MASK (1U << 8U)      /*!<@brief PORT pin mask */
                                                     /* @} */
...
/* Symbols to be used with GPIO driver */
#define UART_INITPINS_trigger1_FGPIO FGPIOA             /*!<@brief FGPIO peripheral base pointer */
#define UART_INITPINS_trigger1_GPIO GPIOA               /*!<@brief GPIO peripheral base pointer */
#define UART_INITPINS_trigger1_GPIO_PIN_MASK (1U << 9U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define UART_INITPINS_trigger1_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define UART_INITPINS_trigger1_PIN 9U                   /*!<@brief PORT pin number */
#define UART_INITPINS_trigger1_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                        /* @} */
...
/* Symbols to be used with PORT driver */
#define UART_INITPINS_Pot1_PORT PORTB                /*!<@brief PORT peripheral base pointer */
#define UART_INITPINS_Pot1_PIN 13U                   /*!<@brief PORT pin number */
#define UART_INITPINS_Pot1_PIN_MASK (1U << 13U)      /*!<@brief PORT pin mask */
                                                     /* @} */
...
/* Symbols to be used with PORT driver */
#define UART_INITPINS_Pot2_PORT PORTB               /*!<@brief PORT peripheral base pointer */
#define UART_INITPINS_Pot2_PIN 9U                   /*!<@brief PORT pin number */
#define UART_INITPINS_Pot2_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                    /* @} */
